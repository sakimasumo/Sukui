									...
									<div class="itemimg">
										...
										<div class="itemsubimg">
											...
											<?php foreach ($imageid as $id) : ?>
												<a href="<?php usces_the_itemImageURL($id); ?>" <?php echo apply_filters('usces_itemimg_anchor_rel', NULL); ?>><?php usces_the_itemImage($id, 72, 56, $post); ?></a>
											<?php endforeach; ?>
