...
<!--		<input type="radio" name="upload_mode" id="upload_mode_custom" value="custom" /><label for="upload_mode_custom"><?php _e('Custom Field columns', 'usces'); ?></label> -->
...
<!--		<input type="radio" name="download_mode" id="download_mode_custom" value="custom" /><label for="download_mode_custom"><?php _e('Custom Field columns', 'usces'); ?></label> -->
