	...
	<form action="" method="post" name="telecom_form" id="telecom_form">
		<table class="settle_table">
			<tr>
				...
				<td><input name="clientip" type="text" id="clientip_telecom" value="<?php echo esc_html( isset( $acting_opts['clientip'] ) ? $acting_opts['clientip'] : '' ); ?>" size="20" maxlength="5" /></td>
			</tr>
			<tr id="ex_clientip_telecom" class="explanation"><td colspan="2">契約時に<?php echo $this->acting_name; ?>から発行されるクライアントIP（半角数字）</td></tr>
			<tr>
				<th><a class="explanation-label" id="label_ex_stype_telecom">決済タイプ</a></th>
				<td><input name="stype" type="text" id="stype_telecom" value="<?php echo esc_html( isset( $acting_opts['stype'] ) ? $acting_opts['stype'] : '' ); ?>" size="20" /></td>
			</tr>
