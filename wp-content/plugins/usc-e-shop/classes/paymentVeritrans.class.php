	...
	<form action="" method="post" name="veritrans_form" id="veritrans_form">
		<table class="settle_table">
			<tr>
				...
				<td><input name="merchant_id" type="text" id="merchant_id_veritrans" value="<?php echo esc_html( isset( $acting_opts['merchant_id'] ) ? $acting_opts['merchant_id'] : ''); ?>" size="50" maxlength="22" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="merchanthash" type="text" id="merchanthash_veritrans" value="<?php echo esc_html(isset( $acting_opts['merchanthash'] ) ? $acting_opts['merchanthash'] : ''); ?>" size="50" /></td>
			</tr>
