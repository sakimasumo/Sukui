	...
	<form action="" method="post" name="anotherlane_form" id="anotherlane_form">
		<table class="settle_table">
			<tr>
				...
				<td><input name="siteid" type="text" id="siteid_anotherlane" value="<?php echo esc_html( isset( $acting_opts['siteid'] ) ? $acting_opts['siteid'] : '' ); ?>" size="20" maxlength="8" /></td>
			</tr>
			<tr id="ex_siteid_anotherlane" class="explanation"><td colspan="2">契約時に<?php echo $this->acting_name; ?>から発行されるID（半角数字）</td></tr>
			<tr>
				<th><a class="explanation-label" id="label_ex_sitepass_anotherlane">サイトパスワード</a></th>
				<td><input name="sitepass" type="text" id="sitepass_anotherlane" value="<?php echo esc_html( isset( $acting_opts['sitepass'] ) ? $acting_opts['sitepass'] : '' ); ?>" size="20" maxlength="8" /></td>
			</tr>
			<tr id="ex_sitepass_anotherlane" class="explanation"><td colspan="2">契約時に<?php echo $this->acting_name; ?>から発行されるパスワード（半角英数字）</td></tr>
			<tr>
