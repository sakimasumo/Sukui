	...
	<form action="" method="post" name="paygent_form" id="paygent_form">
		<table class="settle_table">
			<tr>
				...
				<td><input name="seq_merchant_id" type="text" id="seq_merchant_id_paygent" value="<?php echo esc_html( isset( $acting_opts['seq_merchant_id'] ) ? $acting_opts['seq_merchant_id'] : '' ); ?>" size="20" maxlength="9" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="hc" type="text" id="hc_paygent" value="<?php echo esc_html( isset( $acting_opts['hc'] ) ? $acting_opts['hc'] : '' ); ?>" size="20" maxlength="24" /></td>
			</tr>
		...
		<table class="settle_table">
			...
			<tr>
				...
				<td><input name="payment_term_day" type="text" id="payment_term_day_paygent" value="<?php echo esc_html( isset( $acting_opts['payment_term_day'] ) ? $acting_opts['payment_term_day'] : '5' ); ?>" size="6" maxlength="2" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="payment_term_min" type="text" id="payment_term_min_paygent" value="<?php echo esc_html( isset( $acting_opts['payment_term_min'] ) ? $acting_opts['payment_term_min'] : '' ); ?>" size="6" maxlength="4" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="conv_hc" type="text" id="conv_hc_paygent" value="<?php echo esc_html( isset( $acting_opts['conv_hc'] ) ? $acting_opts['conv_hc'] : '' ); ?>" size="20" maxlength="24" /></td>
			</tr>
