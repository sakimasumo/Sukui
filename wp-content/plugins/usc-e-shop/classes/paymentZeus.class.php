	...
	<form action="" method="post" name="zeus_form" id="zeus_form">
		<table class="settle_table">
			...
			<tr>
				...
				<td><input name="clientip" type="text" id="clid_zeus" value="<?php if( isset( $acting_opts['clientip'] ) ) echo esc_html( $acting_opts['clientip'] ); ?>" size="40" /></td>
			</tr>
			...
			<tr class="authkey_zeus">
				...
				<td><input name="authkey" type="text" id="clid_zeus" value="<?php if( isset( $acting_opts['authkey'] ) ) echo esc_html( $acting_opts['authkey'] ); ?>" size="40" /></td>
			</tr>
		...
		<table class="settle_table">
			...
			<tr>
				...
				<td><input name="clientip_bank" type="text" id="bank_clid_zeus" value="<?php if( isset( $acting_opts['clientip_bank'] ) ) echo esc_html( $acting_opts['clientip_bank'] ); ?>" size="40" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="testid_bank" type="text" id="testid_bank_zeus" value="<?php if( isset( $acting_opts['testid_bank'] ) ) echo esc_html( $acting_opts['testid_bank'] ); ?>" size="40" /></td>
			</tr>
		...
		<table class="settle_table">
			...
			<tr>
				...
				<td><input name="clientip_conv" type="text" id="conv_clid_zeus" value="<?php if( isset( $acting_opts['clientip_conv'] ) ) echo esc_html( $acting_opts['clientip_conv'] ); ?>" size="40" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="testid_conv" type="text" id="testid_conv_zeus" value="<?php if( isset( $acting_opts['testid_conv'] ) ) echo esc_html( $acting_opts['testid_conv'] ); ?>" size="40" /></td>
			</tr>
