	...
	<form action="" method="post" name="mizuho_form" id="mizuho_form">
		<table class="settle_table">
			<tr>
				...
				<td><input name="shopid" type="text" id="shopid" value="<?php echo esc_html( isset( $acting_opts['shopid'] ) ? $acting_opts['shopid'] : '' ); ?>" size="20" maxlength="6" /></td>
			</tr>
			<tr id="ex_shopid_mizuho" class="explanation"><td colspan="2">契約時に<?php echo $this->acting_name; ?>から発行される加盟店コード（半角数字6桁）</td></tr>
			<tr>
				<th><a class="explanation-label" id="label_ex_cshopid_mizuho">加盟店サブコード</a></th>
				<td><input name="cshopid" type="text" id="cshopid" value="<?php echo esc_html( isset( $acting_opts['cshopid'] ) ? $acting_opts['cshopid'] : '' ); ?>" size="20" maxlength="5" /></td>
			</tr>
			<tr id="ex_cshopid_mizuho" class="explanation"><td colspan="2">契約時に<?php echo $this->acting_name; ?>から発行される加盟店サブコード（半角数字5桁）</td></tr>
			<tr>
				<th><a class="explanation-label" id="label_ex_hash_pass_mizuho">ハッシュ用パスワード</a></th>
				<td><input name="hash_pass" type="text" id="hash_pass" value="<?php echo esc_html( isset( $acting_opts['hash_pass'] ) ? $acting_opts['hash_pass'] : '' ); ?>" size="20" maxlength="20" /></td>
			</tr>
			<tr id="ex_hash_pass_mizuho" class="explanation"><td colspan="2">契約時に<?php echo $this->acting_name; ?>から発行されるハッシュ用パスワード（半角英数字）</td></tr>
			<tr>
			...
			<tr>
				...
				<td><input name="send_url" type="text" id="send_url_mizuho" value="<?php echo esc_html( isset( $acting_opts['send_url'] ) ? $acting_opts['send_url'] : '' ); ?>" size="50" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="send_url_mbl" type="text" id="send_url_mbl_mizuho" value="<?php echo esc_html( isset( $acting_opts['send_url_mbl'] ) ? $acting_opts['send_url_mbl'] : '' ); ?>" size="50" /></td>
			</tr>
