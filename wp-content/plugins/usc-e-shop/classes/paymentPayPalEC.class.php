	...
	<form action="" method="post" name="paypal_form" id="paypal_form">
		<table class="settle_table">
			...
			<tr class="paypal_ec_form">
				...
				<td><input name="user" type="text" id="user_paypal" value="<?php echo esc_html( isset( $acting_opts['user'] ) ? $acting_opts['user'] : '' ); ?>" size="50" /></td>
			</tr>
			...
			<tr class="paypal_ec_form">
				...
				<td><input name="pwd" type="text" id="pwd_paypal" value="<?php echo esc_html( isset( $acting_opts['pwd'] ) ? $acting_opts['pwd'] : '' ); ?>" size="50" /></td>
			</tr>
			...
			<tr class="paypal_ec_form">
				...
				<td><input name="signature" type="text" id="signature_paypal" value="<?php echo esc_html( isset( $acting_opts['signature'] ) ? $acting_opts['signature'] : '' ); ?>" size="50" /><span id="get_paypal_signature"></span></td>
			</tr>
			...
			<tr class="paypal_ec_form">
				...
				<td><input name="paypal_acount" type="text" id="acount_paypal" value="<?php echo esc_html( isset( $acting_opts['paypal_acount'] ) ? $acting_opts['paypal_acount'] : '' ); ?>" size="50" /></td>
			</tr>
		...
		<!--<table class="settle_table paypal_ec_form">
			<tr>
				...
				<td><input name="logoimg" type="text" id="logoimg" value="<?php echo esc_html(isset( $acting_opts['logoimg'] ) ? $acting_opts['logoimg'] : '' ); ?>" size="50" /></td>
			</tr>
			...
			<tr id="cartbordercolor">
				...
				<td>#<input name="cartbordercolor" type="text" value="<?php echo esc_html( isset( $acting_opts['cartbordercolor'] ) ? $acting_opts['cartbordercolor'] : '' ); ?>" size="8" class="color" /></td>
			</tr>
		</table>-->
		<table class="settle_table paypal_ec_form">
			<tr>
			...
			<tr class="paypal_ec_form_login_with_paypal">
				...
				<td><input name="liwp_client_id" type="text" id="liwp_client_id" value="<?php echo esc_html( isset( $acting_opts['liwp_client_id'] ) ? $acting_opts['liwp_client_id'] : '' ); ?>" size="50" /></td>
			</tr>
			...
			<tr class="paypal_ec_form_login_with_paypal">
				...
				<td><input name="liwp_secret" type="text" id="liwp_secret" value="<?php echo esc_html( isset( $acting_opts['liwp_secret'] ) ? $acting_opts['liwp_secret'] : '' ); ?>" size="50" /></td>
			</tr>
			...
			<tr class="paypal_ec_form_login_with_paypal">
				...
				<td><input name="liwp_client_id_sand" type="text" id="liwp_client_id_sand" value="<?php echo esc_html( isset( $acting_opts['liwp_client_id_sand'] ) ? $acting_opts['liwp_client_id_sand'] : '' ); ?>" size="50" /></td>
			</tr>
			...
			<tr class="paypal_ec_form_login_with_paypal">
				...
				<td><input name="liwp_secret_sand" type="text" id="liwp_secret_sand" value="<?php echo esc_html( isset( $acting_opts['liwp_secret_sand'] ) ? $acting_opts['liwp_secret_sand'] : '' ); ?>" size="50" /></td>
			</tr>
