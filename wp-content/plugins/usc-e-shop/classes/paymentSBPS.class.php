	...
	<form action="" method="post" name="sbps_form" id="sbps_form">
		<table class="settle_table">
			<tr>
				...
				<td><input name="merchant_id" type="text" id="merchant_id_sbps" value="<?php echo esc_html( isset( $acting_opts['merchant_id'] ) ? $acting_opts['merchant_id'] : '' ); ?>" size="20" maxlength="5" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="service_id" type="text" id="service_id_sbps" value="<?php echo esc_html( isset( $acting_opts['service_id'] ) ? $acting_opts['service_id'] : '' ); ?>" size="20" maxlength="3" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="hash_key" type="text" id="hash_key_sbps" value="<?php echo esc_html( isset( $acting_opts['hash_key'] ) ? $acting_opts['hash_key'] : '' ); ?>" size="40" maxlength="40" /></td>
			</tr>
		...
		<table class="settle_table">
			...
			<tr class="card_token_sbps">
				...
				<td><input name="3des_key" type="text" id="3des_key_sbps" value="<?php echo esc_html( isset( $acting_opts['3des_key'] ) ? $acting_opts['3des_key'] : '' ); ?>" size="40" maxlength="40" /></td>
			</tr>
			...
			<tr class="card_token_sbps">
				...
				<td><input name="3desinit_key" type="text" id="3desinit_key_sbps" value="<?php echo esc_html( isset( $acting_opts['3desinit_key'] ) ? $acting_opts['3desinit_key'] : '' ); ?>" size="40" maxlength="40" /></td>
			</tr>
			...
			<tr class="card_token_sbps">
				...
				<td><input name="basic_id" type="text" id="basic_id_sbps" value="<?php echo esc_html( isset( $acting_opts['basic_id'] ) ? $acting_opts['basic_id'] : '' ); ?>" size="40" maxlength="40" /></td>
			</tr>
			...
			<tr class="card_token_sbps">
				...
				<td><input name="basic_password" type="text" id="basic_password_sbps" value="<?php echo esc_html( isset( $acting_opts['basic_password'] ) ? $acting_opts['basic_password'] : '' ); ?>" size="40" maxlength="40" /></td>
			</tr>
