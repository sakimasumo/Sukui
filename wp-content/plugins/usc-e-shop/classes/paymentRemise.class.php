	...
	<form action="" method="post" name="remise_form" id="remise_form">
		<table class="settle_table">
			...
			<tr>
				...
				<td><input name="SHOPCO" type="text" id="SHOPCO_remise" value="<?php echo esc_html( isset( $acting_opts['SHOPCO'] ) ? $acting_opts['SHOPCO'] : '' ); ?>" size="20" maxlength="8" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="HOSTID" type="text" id="HOSTID_remise" value="<?php echo esc_html( isset( $acting_opts['HOSTID'] ) ? $acting_opts['HOSTID'] : '' ); ?>" size="20" maxlength="8" /></td>
			</tr>
		...
		<table class="settle_table">
			...
			<tr class="card_form_remise">
				...
				<td><input name="send_url_pc" type="text" id="send_url_pc_remise" value="<?php echo esc_html( isset( $acting_opts['send_url_pc'] ) ? $acting_opts['send_url_pc'] : '' ); ?>" size="40" /></td>
			</tr>
			...
			<tr class="card_form_remise">
				...
				<td><input name="send_url_mbl" type="text" id="send_url_mbl_remise" value="<?php echo esc_html( isset( $acting_opts['send_url_mbl'] ) ? $acting_opts['send_url_mbl'] : '' ); ?>" size="40" /></td>
			</tr>
		...
		<table class="settle_table">
			...
			<tr class="conv_form_remise">
				...
				<td><input name="S_PAYDATE" type="text" id="S_PAYDATE_remise" value="<?php echo esc_html( isset( $acting_opts['S_PAYDATE'] ) ? $acting_opts['S_PAYDATE'] : '' ); ?>" size="5" maxlength="3" />日</td>
			</tr>
			...
			<tr class="conv_form_remise">
				...
				<td><input name="send_url_cvs_pc" type="text" id="send_url_cvs_pc_remise" value="<?php echo esc_html( isset( $acting_opts['send_url_cvs_pc'] ) ? $acting_opts['send_url_cvs_pc'] : '' ); ?>" size="40" /></td>
			</tr>
			...
			<tr class="conv_form_remise">
				...
				<td><input name="send_url_cvs_mbl" type="text" id="send_url_cvs_mbl_remise" value="<?php echo esc_html( isset( $acting_opts['send_url_cvs_mbl'] ) ? $acting_opts['send_url_cvs_mbl'] : '' ); ?>" size="40" /></td>
			</tr>
