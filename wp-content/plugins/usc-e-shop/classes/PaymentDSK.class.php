...
class DSK_SETTLEMENT extends SBPS_MAIN
{
	...
	public function initialize_data() {
		...
		if( !isset( $options['acting_settings'] ) || !isset( $options['acting_settings']['dsk'] ) ) {
...
<?php
	...
	public function settlement_update() {
		...
		$options['acting_settings']['dsk']['merchant_id'] = ( isset( $_POST['merchant_id'] ) ) ? trim( $_POST['merchant_id'] ) : '';
		$options['acting_settings']['dsk']['service_id'] = ( isset( $_POST['service_id'] ) ) ? trim( $_POST['service_id'] ) : '';
		$options['acting_settings']['dsk']['hash_key'] = ( isset( $_POST['hash_key'] ) ) ? trim( $_POST['hash_key'] ) : '';
