	...
	<form action="" method="post" name="epsilon_form" id="epsilon_form">
		<table class="settle_table">
			<tr>
				...
				<td><input name="contract_code" type="text" id="contract_code_epsilon" value="<?php echo ( isset( $acting_opts['contract_code'] ) ? $acting_opts['contract_code'] : '' ); ?>" size="20" maxlength="8" /></td>
			</tr>
