	...
	<form action="" method="post" name="yahoo_form" id="yahoo_form">
		<table class="settle_table">
			...
			<tr>
				...
				<td><input name="merchant_id" type="text" id="merchant_id_yahoo" value="<?php echo esc_html(isset($opts['yahoo']['merchant_id']) ? $opts['yahoo']['merchant_id'] : ''); ?>" size="20" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="merchant_key" type="text" id="merchant_key_yahoo" value="<?php echo esc_html(isset($opts['yahoo']['merchant_key']) ? $opts['yahoo']['merchant_key'] : ''); ?>" size="50" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="expire_yahoo" type="text" id="expire_yahoo" value="<?php echo esc_html(isset($opts['yahoo']['expire']) ? $opts['yahoo']['expire'] : '10'); ?>" size="10" />時間</td>
			</tr>
