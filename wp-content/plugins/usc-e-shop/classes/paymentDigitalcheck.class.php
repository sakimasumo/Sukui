	...
	<form action="" method="post" name="digitalcheck_form" id="digitalcheck_form">
		<table class="settle_table">
			...
			<tr>
				...
				<td><input name="card_ip" type="text" id="card_ip_digitalcheck" value="<?php echo esc_html( isset( $acting_opts['card_ip'] ) ? $acting_opts['card_ip'] : ''); ?>" size="20" maxlength="10" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="card_pass" type="text" id="card_pass_digitalcheck" value="<?php echo esc_html( isset( $acting_opts['card_pass'] ) ? $acting_opts['card_pass'] : ''); ?>" size="20" maxlength="10" /></td>
			</tr>
		...
		<table class="settle_table">
			...
			<tr>
				...
				<td><input name="conv_ip" type="text" id="conv_ip_digitalcheck" value="<?php echo esc_html( isset( $acting_opts['conv_ip'] ) ? $acting_opts['conv_ip'] : '' ); ?>" size="20" maxlength="10" /></td>
			</tr>
